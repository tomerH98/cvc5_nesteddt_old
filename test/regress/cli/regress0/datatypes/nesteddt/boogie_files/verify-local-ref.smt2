; using cav@cav20-artifact:~/artifact/libra/language/move-prover/bytecode-to-boogie$ time cargo run test_mvir/verify-stdlib/verify-local-ref.mvir --output verify-local-ref.bpl --boogie-exe ~/boogie/Binaries/boogie -B /useArrayTheory --z3-exe /usr/bin/z3 --boogie /proverLog:verify-local-ref.smt2
(set-logic ALL)
...
(push 1)
(set-info :boogie-vc-id TestSpecs_mut_b_verify)
(assert (not
(let ((inline$WriteRef$0$anon0_correct  (=> (! (and %lbl%+0 true) :lblpos +0) true)))
(let ((inline$WriteRef$0$Entry_correct  (=> (! (and %lbl%+1 true) :lblpos +1) (=> (= inline$WriteRef$0$new_v@0 (GetLocal m@0 (+ local_counter 1))) inline$WriteRef$0$anon0_correct))))
(let ((inline$TestSpecs_mut_b$0$anon0$1_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (= m@0 (UpdateLocal m@@5 (+ local_counter 1) inline$LdConst$0$ret@1)) inline$WriteRef$0$Entry_correct))))
(let ((inline$LdConst$0$anon0_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (= inline$LdConst$0$ret@1 (Integer 10)) inline$TestSpecs_mut_b$0$anon0$1_correct))))
(let ((inline$TestSpecs_mut_b$0$anon0_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (not abort_flag) (=> (and (and (is-Integer (Dereference m@@5 b)) (>= (|i#Integer| (Dereference m@@5 b)) 0)) (<= (|i#Integer| (Dereference m@@5 b)) MAX_U64)) (=> (and (and (and (and (and (=> (is-Local (|l#Reference| b)) (< (|i#Local| (|l#Reference| b)) local_counter)) (and (>= (|size#Path| (|p#Reference| b)) 0) (< (|size#Path| (|p#Reference| b)) StratificationDepth))) (or (= (|size#Path| (|p#Reference| b)) 0) (and (and (is-Vector (select (|contents#Memory| m@@5) (|l#Reference| b))) (>= (select (|p#Path| (|p#Reference| b)) 0) 0)) (< (select (|p#Path| (|p#Reference| b)) 0) (vlen (select (|contents#Memory| m@@5) (|l#Reference| b))))))) (or (<= (|size#Path| (|p#Reference| b)) 1) (and (and (is-Vector (ReadValue (Path (|p#Path| (|p#Reference| b)) 1) (select (|contents#Memory| m@@5) (|l#Reference| b)))) (>= (select (|p#Path| (|p#Reference| b)) 1) 0)) (< (select (|p#Path| (|p#Reference| b)) 1) (vlen (ReadValue (Path (|p#Path| (|p#Reference| b)) 1) (select (|contents#Memory| m@@5) (|l#Reference| b)))))))) (or (<= (|size#Path| (|p#Reference| b)) 2) (and (and (is-Vector (ReadValue (Path (|p#Path| (|p#Reference| b)) 2) (select (|contents#Memory| m@@5) (|l#Reference| b)))) (>= (select (|p#Path| (|p#Reference| b)) 1) 0)) (< (select (|p#Path| (|p#Reference| b)) 1) (vlen (ReadValue (Path (|p#Path| (|p#Reference| b)) 2) (select (|contents#Memory| m@@5) (|l#Reference| b)))))))) (= local_counter@0 (+ local_counter 3))) inline$LdConst$0$anon0_correct))))))
(let ((inline$TestSpecs_mut_b$0$Entry_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (and (! (or %lbl%@6 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @6) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_mut_b$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_mut_b$0$Entry_correct))))
...
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%+5 () Bool)
(declare-fun inline$TestSpecs_mut_ref$0$tmp@2 () T@Value)
(declare-fun %lbl%+6 () Bool)
(declare-fun abort_flag () Bool)
(declare-fun %lbl%+7 () Bool)
(declare-fun %lbl%+8 () Bool)
...
(declare-fun inline$TestSpecs_mut_ref$0$tmp@1 () T@Value)
...
(push 1)
(set-info :boogie-vc-id TestSpecs_mut_ref_verify)
(assert (not
(let ((inline$TestSpecs_mut_ref$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1  (=> (|b#Boolean| (Boolean true)) (not abort_flag@0))) :lblneg @1))))
(let ((inline$TestSpecs_mut_ref$0$Label_Abort_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) inline$TestSpecs_mut_ref$0$Return_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon6_Else$1_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (= m@10 (UpdateLocal m@9 (+ local_counter 11) inline$LdConst$3$ret@1)) inline$TestSpecs_mut_ref$0$Label_Abort_correct))))
(let ((inline$LdConst$3$anon0_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= inline$LdConst$3$ret@1 (Integer 42)) inline$TestSpecs_mut_ref$0$anon6_Else$1_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon6_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (|b#Boolean| inline$TestSpecs_mut_ref$0$tmp@2) inline$LdConst$3$anon0_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> abort_flag inline$TestSpecs_mut_ref$0$Label_Abort_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon6_Then_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (not (|b#Boolean| inline$TestSpecs_mut_ref$0$tmp@2)) (=> (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0)) inline$TestSpecs_mut_ref$0$Return_correct)))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Else$6_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (and (= m@9 (UpdateLocal m@8 (+ local_counter 10) inline$Not$0$dst@1)) (= inline$TestSpecs_mut_ref$0$tmp@2 (GetLocal m@9 (+ local_counter 10)))) (and inline$TestSpecs_mut_ref$0$anon6_Then_correct inline$TestSpecs_mut_ref$0$anon6_Else_correct)))))
(let ((inline$Not$0$anon0_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (and (is-Boolean inline$Not$0$src@0) (= inline$Not$0$dst@1 (Boolean  (not (|b#Boolean| inline$Not$0$src@0))))) inline$TestSpecs_mut_ref$0$anon5_Else$6_correct))))
(let ((inline$Not$0$Entry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$Not$0$src@0 (GetLocal m@8 (+ local_counter 9))) inline$Not$0$anon0_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Else$5_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (= m@7 (UpdateLocal m@6 (+ local_counter 8) inline$LdConst$2$ret@1)) (=> (and (= inline$TestSpecs_mut_ref$0$tmp@1 (Boolean (IsEqual (GetLocal m@7 (+ local_counter 7)) (GetLocal m@7 (+ local_counter 8))))) (= m@8 (UpdateLocal m@7 (+ local_counter 9) inline$TestSpecs_mut_ref$0$tmp@1))) inline$Not$0$Entry_correct)))))
(let ((inline$LdConst$2$anon0_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (= inline$LdConst$2$ret@1 (Integer 10)) inline$TestSpecs_mut_ref$0$anon5_Else$5_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Else$4_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (= m@6 (UpdateLocal m@5 (+ local_counter 7) inline$CopyOrMoveValue$2$local@0)) inline$LdConst$2$anon0_correct))))
(let ((inline$CopyOrMoveValue$2$Entry_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (= inline$CopyOrMoveValue$2$local@0 (GetLocal m@5 (+ local_counter 0))) inline$TestSpecs_mut_ref$0$anon5_Else$4_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Else$3_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (= m@5 (UpdateLocal m@4 (+ local_counter 0) inline$CopyOrMoveValue$1$local@0)) inline$CopyOrMoveValue$2$Entry_correct))))
(let ((inline$CopyOrMoveValue$1$Entry_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (= inline$CopyOrMoveValue$1$local@0 (GetLocal m@4 (+ local_counter 6))) inline$TestSpecs_mut_ref$0$anon5_Else$3_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Else$2_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (=> (and (and (and (is-Integer inline$ReadRef$0$v@1) (>= (|i#Integer| inline$ReadRef$0$v@1) 0)) (<= (|i#Integer| inline$ReadRef$0$v@1) MAX_U64)) (= m@4 (UpdateLocal m@3 (+ local_counter 6) inline$ReadRef$0$v@1))) inline$CopyOrMoveValue$1$Entry_correct))))
(let ((inline$ReadRef$0$anon0_correct  (=> (! (and %lbl%+18 true) :lblpos +18) (=> (= inline$ReadRef$0$v@1 (ReadValue (|p#Reference| inline$BorrowLoc$0$dst@1) (select (|contents#Memory| m@3) (|l#Reference| inline$BorrowLoc$0$dst@1)))) inline$TestSpecs_mut_ref$0$anon5_Else$2_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon5_Else_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (not abort_flag) inline$ReadRef$0$anon0_correct))))
(let ((inline$WriteRef$0$anon0_correct  (=> (! (and %lbl%+20 true) :lblpos +20) (=> (and (and (= inline$WriteRef$0$l@1 (|l#Reference| inline$BorrowLoc$0$dst@1)) (= inline$WriteRef$0$v@1 (select (|contents#Memory| m@2) inline$WriteRef$0$l@1))) (and (= inline$WriteRef$0$v@2 (UpdateValue (|p#Reference| inline$BorrowLoc$0$dst@1) inline$WriteRef$0$v@1 inline$WriteRef$0$new_v@0)) (= m@3 (Memory (|domain#Memory| m@2) (store (|contents#Memory| m@2) inline$WriteRef$0$l@1 inline$WriteRef$0$v@2))))) (and inline$TestSpecs_mut_ref$0$anon5_Then_correct inline$TestSpecs_mut_ref$0$anon5_Else_correct)))))
(let ((inline$WriteRef$0$Entry_correct  (=> (! (and %lbl%+21 true) :lblpos +21) (=> (= inline$WriteRef$0$new_v@0 (GetLocal m@2 (+ local_counter@0 1))) inline$WriteRef$0$anon0_correct))))
(let ((inline$TestSpecs_mut_b$0$anon0$1_correct  (=> (! (and %lbl%+22 true) :lblpos +22) (=> (= m@2 (UpdateLocal m@1 (+ local_counter@0 1) inline$LdConst$1$ret@1)) inline$WriteRef$0$Entry_correct))))
(let ((inline$LdConst$1$anon0_correct  (=> (! (and %lbl%+23 true) :lblpos +23) (=> (= inline$LdConst$1$ret@1 (Integer 10)) inline$TestSpecs_mut_b$0$anon0$1_correct))))
(let ((inline$TestSpecs_mut_b$0$anon0_correct  (=> (! (and %lbl%+24 true) :lblpos +24) (=> (not abort_flag) (=> (and (and (is-Integer (Dereference m@1 inline$BorrowLoc$0$dst@1)) (>= (|i#Integer| (Dereference m@1 inline$BorrowLoc$0$dst@1)) 0)) (<= (|i#Integer| (Dereference m@1 inline$BorrowLoc$0$dst@1)) MAX_U64)) (=> (and (and (and (and (and (=> (is-Local (|l#Reference| inline$BorrowLoc$0$dst@1)) (< (|i#Local| (|l#Reference| inline$BorrowLoc$0$dst@1)) local_counter@0)) (and (>= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) (< (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) StratificationDepth))) (or (= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) (and (and (is-Vector (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1))) (>= (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) 0)) (< (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) (vlen (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1))))))) (or (<= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (and (and (is-Vector (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))) (>= (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) 0)) (< (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (vlen (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))))))) (or (<= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 2) (and (and (is-Vector (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 2) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))) (>= (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) 0)) (< (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (vlen (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 2) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))))))) (= local_counter@1 (+ local_counter@0 3))) inline$LdConst$1$anon0_correct))))))
(let ((inline$TestSpecs_mut_b$0$Entry_correct  (=> (! (and %lbl%+25 true) :lblpos +25) (and (! (or %lbl%@26 (ExistsTxnSenderAccount m@1 txn@@1)) :lblneg @26) (=> (ExistsTxnSenderAccount m@1 txn@@1) inline$TestSpecs_mut_b$0$anon0_correct)))))
(let ((inline$BorrowLoc$0$anon0_correct  (=> (! (and %lbl%+27 true) :lblpos +27) (=> (= inline$BorrowLoc$0$dst@1 (Reference (Local inline$BorrowLoc$0$l@0) EmptyPath)) inline$TestSpecs_mut_b$0$Entry_correct))))
(let ((inline$BorrowLoc$0$Entry_correct  (=> (! (and %lbl%+28 true) :lblpos +28) (=> (= inline$BorrowLoc$0$l@0 (+ local_counter 0)) inline$BorrowLoc$0$anon0_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon0$2_correct  (=> (! (and %lbl%+29 true) :lblpos +29) (=> (= m@1 (UpdateLocal m@0 (+ local_counter 0) inline$CopyOrMoveValue$0$local@0)) inline$BorrowLoc$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+30 true) :lblpos +30) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 2))) inline$TestSpecs_mut_ref$0$anon0$2_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon0$1_correct  (=> (! (and %lbl%+31 true) :lblpos +31) (=> (= m@0 (UpdateLocal m@@5 (+ local_counter 2) inline$LdConst$0$ret@1)) inline$CopyOrMoveValue$0$Entry_correct))))
(let ((inline$LdConst$0$anon0_correct  (=> (! (and %lbl%+32 true) :lblpos +32) (=> (= inline$LdConst$0$ret@1 (Integer 20)) inline$TestSpecs_mut_ref$0$anon0$1_correct))))
(let ((inline$TestSpecs_mut_ref$0$anon0_correct  (=> (! (and %lbl%+33 true) :lblpos +33) (=> (and (not abort_flag) (= local_counter@0 (+ local_counter 12))) inline$LdConst$0$anon0_correct))))
(let ((inline$TestSpecs_mut_ref$0$Entry_correct  (=> (! (and %lbl%+34 true) :lblpos +34) (and (! (or %lbl%@35 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @35) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_mut_ref$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+36 true) :lblpos +36) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_mut_ref$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+37 true) :lblpos +37) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))))))))))))))))))
))
(check-sat)
(pop 1)
...
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%+5 () Bool)
(declare-fun inline$TestSpecs_mut_ref_failure$0$tmp@2 () T@Value)
(declare-fun %lbl%+6 () Bool)
(declare-fun abort_flag () Bool)
(declare-fun %lbl%+7 () Bool)
(declare-fun %lbl%+8 () Bool)
...
(declare-fun m@6 () T@Memory)
(declare-fun inline$LdConst$2$ret@1 () T@Value)
(declare-fun inline$TestSpecs_mut_ref_failure$0$tmp@1 () T@Value)
(declare-fun %lbl%+12 () Bool)
(declare-fun %lbl%+13 () Bool)
(declare-fun m@5 () T@Memory)
(declare-fun inline$CopyOrMoveValue$2$local@0 () T@Value)
...
(declare-fun %lbl%+37 () Bool)
(push 1)
(set-info :boogie-vc-id TestSpecs_mut_ref_failure_verify)
(assert (not
(let ((inline$TestSpecs_mut_ref_failure$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1  (=> (|b#Boolean| (Boolean true)) (not abort_flag@0))) :lblneg @1))))
(let ((inline$TestSpecs_mut_ref_failure$0$Label_Abort_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) inline$TestSpecs_mut_ref_failure$0$Return_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon6_Else$1_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (= m@10 (UpdateLocal m@9 (+ local_counter 11) inline$LdConst$3$ret@1)) inline$TestSpecs_mut_ref_failure$0$Label_Abort_correct))))
(let ((inline$LdConst$3$anon0_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= inline$LdConst$3$ret@1 (Integer 42)) inline$TestSpecs_mut_ref_failure$0$anon6_Else$1_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon6_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (|b#Boolean| inline$TestSpecs_mut_ref_failure$0$tmp@2) inline$LdConst$3$anon0_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> abort_flag inline$TestSpecs_mut_ref_failure$0$Label_Abort_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon6_Then_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (not (|b#Boolean| inline$TestSpecs_mut_ref_failure$0$tmp@2)) (=> (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0)) inline$TestSpecs_mut_ref_failure$0$Return_correct)))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Else$6_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (and (= m@9 (UpdateLocal m@8 (+ local_counter 10) inline$Not$0$dst@1)) (= inline$TestSpecs_mut_ref_failure$0$tmp@2 (GetLocal m@9 (+ local_counter 10)))) (and inline$TestSpecs_mut_ref_failure$0$anon6_Then_correct inline$TestSpecs_mut_ref_failure$0$anon6_Else_correct)))))
(let ((inline$Not$0$anon0_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (and (is-Boolean inline$Not$0$src@0) (= inline$Not$0$dst@1 (Boolean  (not (|b#Boolean| inline$Not$0$src@0))))) inline$TestSpecs_mut_ref_failure$0$anon5_Else$6_correct))))
(let ((inline$Not$0$Entry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$Not$0$src@0 (GetLocal m@8 (+ local_counter 9))) inline$Not$0$anon0_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Else$5_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (= m@7 (UpdateLocal m@6 (+ local_counter 8) inline$LdConst$2$ret@1)) (=> (and (= inline$TestSpecs_mut_ref_failure$0$tmp@1 (Boolean (IsEqual (GetLocal m@7 (+ local_counter 7)) (GetLocal m@7 (+ local_counter 8))))) (= m@8 (UpdateLocal m@7 (+ local_counter 9) inline$TestSpecs_mut_ref_failure$0$tmp@1))) inline$Not$0$Entry_correct)))))
(let ((inline$LdConst$2$anon0_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (= inline$LdConst$2$ret@1 (Integer 9)) inline$TestSpecs_mut_ref_failure$0$anon5_Else$5_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Else$4_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (= m@6 (UpdateLocal m@5 (+ local_counter 7) inline$CopyOrMoveValue$2$local@0)) inline$LdConst$2$anon0_correct))))
(let ((inline$CopyOrMoveValue$2$Entry_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (= inline$CopyOrMoveValue$2$local@0 (GetLocal m@5 (+ local_counter 0))) inline$TestSpecs_mut_ref_failure$0$anon5_Else$4_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Else$3_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (= m@5 (UpdateLocal m@4 (+ local_counter 0) inline$CopyOrMoveValue$1$local@0)) inline$CopyOrMoveValue$2$Entry_correct))))
(let ((inline$CopyOrMoveValue$1$Entry_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (= inline$CopyOrMoveValue$1$local@0 (GetLocal m@4 (+ local_counter 6))) inline$TestSpecs_mut_ref_failure$0$anon5_Else$3_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Else$2_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (=> (and (and (and (is-Integer inline$ReadRef$0$v@1) (>= (|i#Integer| inline$ReadRef$0$v@1) 0)) (<= (|i#Integer| inline$ReadRef$0$v@1) MAX_U64)) (= m@4 (UpdateLocal m@3 (+ local_counter 6) inline$ReadRef$0$v@1))) inline$CopyOrMoveValue$1$Entry_correct))))
(let ((inline$ReadRef$0$anon0_correct  (=> (! (and %lbl%+18 true) :lblpos +18) (=> (= inline$ReadRef$0$v@1 (ReadValue (|p#Reference| inline$BorrowLoc$0$dst@1) (select (|contents#Memory| m@3) (|l#Reference| inline$BorrowLoc$0$dst@1)))) inline$TestSpecs_mut_ref_failure$0$anon5_Else$2_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon5_Else_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (not abort_flag) inline$ReadRef$0$anon0_correct))))
(let ((inline$WriteRef$0$anon0_correct  (=> (! (and %lbl%+20 true) :lblpos +20) (=> (and (and (= inline$WriteRef$0$l@1 (|l#Reference| inline$BorrowLoc$0$dst@1)) (= inline$WriteRef$0$v@1 (select (|contents#Memory| m@2) inline$WriteRef$0$l@1))) (and (= inline$WriteRef$0$v@2 (UpdateValue (|p#Reference| inline$BorrowLoc$0$dst@1) inline$WriteRef$0$v@1 inline$WriteRef$0$new_v@0)) (= m@3 (Memory (|domain#Memory| m@2) (store (|contents#Memory| m@2) inline$WriteRef$0$l@1 inline$WriteRef$0$v@2))))) (and inline$TestSpecs_mut_ref_failure$0$anon5_Then_correct inline$TestSpecs_mut_ref_failure$0$anon5_Else_correct)))))
(let ((inline$WriteRef$0$Entry_correct  (=> (! (and %lbl%+21 true) :lblpos +21) (=> (= inline$WriteRef$0$new_v@0 (GetLocal m@2 (+ local_counter@0 1))) inline$WriteRef$0$anon0_correct))))
(let ((inline$TestSpecs_mut_b$0$anon0$1_correct  (=> (! (and %lbl%+22 true) :lblpos +22) (=> (= m@2 (UpdateLocal m@1 (+ local_counter@0 1) inline$LdConst$1$ret@1)) inline$WriteRef$0$Entry_correct))))
(let ((inline$LdConst$1$anon0_correct  (=> (! (and %lbl%+23 true) :lblpos +23) (=> (= inline$LdConst$1$ret@1 (Integer 10)) inline$TestSpecs_mut_b$0$anon0$1_correct))))
(let ((inline$TestSpecs_mut_b$0$anon0_correct  (=> (! (and %lbl%+24 true) :lblpos +24) (=> (not abort_flag) (=> (and (and (is-Integer (Dereference m@1 inline$BorrowLoc$0$dst@1)) (>= (|i#Integer| (Dereference m@1 inline$BorrowLoc$0$dst@1)) 0)) (<= (|i#Integer| (Dereference m@1 inline$BorrowLoc$0$dst@1)) MAX_U64)) (=> (and (and (and (and (and (=> (is-Local (|l#Reference| inline$BorrowLoc$0$dst@1)) (< (|i#Local| (|l#Reference| inline$BorrowLoc$0$dst@1)) local_counter@0)) (and (>= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) (< (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) StratificationDepth))) (or (= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) (and (and (is-Vector (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1))) (>= (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) 0)) (< (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 0) (vlen (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1))))))) (or (<= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (and (and (is-Vector (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))) (>= (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) 0)) (< (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (vlen (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))))))) (or (<= (|size#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 2) (and (and (is-Vector (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 2) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))) (>= (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) 0)) (< (select (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 1) (vlen (ReadValue (Path (|p#Path| (|p#Reference| inline$BorrowLoc$0$dst@1)) 2) (select (|contents#Memory| m@1) (|l#Reference| inline$BorrowLoc$0$dst@1)))))))) (= local_counter@1 (+ local_counter@0 3))) inline$LdConst$1$anon0_correct))))))
...
(let ((inline$BorrowLoc$0$anon0_correct  (=> (! (and %lbl%+27 true) :lblpos +27) (=> (= inline$BorrowLoc$0$dst@1 (Reference (Local inline$BorrowLoc$0$l@0) EmptyPath)) inline$TestSpecs_mut_b$0$Entry_correct))))
(let ((inline$BorrowLoc$0$Entry_correct  (=> (! (and %lbl%+28 true) :lblpos +28) (=> (= inline$BorrowLoc$0$l@0 (+ local_counter 0)) inline$BorrowLoc$0$anon0_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon0$2_correct  (=> (! (and %lbl%+29 true) :lblpos +29) (=> (= m@1 (UpdateLocal m@0 (+ local_counter 0) inline$CopyOrMoveValue$0$local@0)) inline$BorrowLoc$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+30 true) :lblpos +30) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 2))) inline$TestSpecs_mut_ref_failure$0$anon0$2_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon0$1_correct  (=> (! (and %lbl%+31 true) :lblpos +31) (=> (= m@0 (UpdateLocal m@@5 (+ local_counter 2) inline$LdConst$0$ret@1)) inline$CopyOrMoveValue$0$Entry_correct))))
(let ((inline$LdConst$0$anon0_correct  (=> (! (and %lbl%+32 true) :lblpos +32) (=> (= inline$LdConst$0$ret@1 (Integer 20)) inline$TestSpecs_mut_ref_failure$0$anon0$1_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$anon0_correct  (=> (! (and %lbl%+33 true) :lblpos +33) (=> (and (not abort_flag) (= local_counter@0 (+ local_counter 12))) inline$LdConst$0$anon0_correct))))
(let ((inline$TestSpecs_mut_ref_failure$0$Entry_correct  (=> (! (and %lbl%+34 true) :lblpos +34) (and (! (or %lbl%@35 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @35) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_mut_ref_failure$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+36 true) :lblpos +36) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_mut_ref_failure$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+37 true) :lblpos +37) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))))))))))))))))))
))
(check-sat)
