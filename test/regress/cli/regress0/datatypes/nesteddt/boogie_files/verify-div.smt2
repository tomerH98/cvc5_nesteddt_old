; using cav@cav20-artifact:~/artifact/libra/language/move-prover/bytecode-to-boogie$ time cargo run test_mvir/verify-stdlib/verify-div.mvir --output verify-div.bpl --boogie-exe ~/boogie/Binaries/boogie -B /useArrayTheory --z3-exe /usr/bin/z3 --boogie /proverLog:verify-div.smt2
(set-logic ALL)
...
(declare-fun inline$TestSpecs_div$0$ret0@1 () T@Value)
...
(push 1)
(set-info :boogie-vc-id TestSpecs_div_verify)
(assert (not
(let ((inline$TestSpecs_div$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1  (=> (|b#Boolean| (Boolean (> (|i#Integer| y) (|i#Integer| (Integer 0))))) (not abort_flag@1))) :lblneg @1))))
(let ((inline$TestSpecs_div$0$anon3_Else$2_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (and (= m@6 (UpdateLocal m@5 (+ local_counter 6) inline$CopyOrMoveValue$3$local@0)) (= inline$TestSpecs_div$0$ret0@1 (GetLocal m@6 (+ local_counter 6)))) (and (=> abort_flag@1 abort_flag@0) (=> abort_flag@0 abort_flag@1))) inline$TestSpecs_div$0$Return_correct))))
(let ((inline$CopyOrMoveValue$3$Entry_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (= inline$CopyOrMoveValue$3$local@0 (GetLocal m@5 (+ local_counter 2))) inline$TestSpecs_div$0$anon3_Else$2_correct))))
(let ((inline$TestSpecs_div$0$anon3_Else$1_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= m@5 (UpdateLocal m@4 (+ local_counter 2) inline$CopyOrMoveValue$2$local@0)) inline$CopyOrMoveValue$3$Entry_correct))))
(let ((inline$CopyOrMoveValue$2$Entry_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (= inline$CopyOrMoveValue$2$local@0 (GetLocal m@4 (+ local_counter 5))) inline$TestSpecs_div$0$anon3_Else$1_correct))))
(let ((inline$TestSpecs_div$0$anon3_Else_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (and (not abort_flag@0) (= m@4 (UpdateLocal m@3 (+ local_counter 5) inline$Div$0$dst))) inline$CopyOrMoveValue$2$Entry_correct))))
(let ((inline$TestSpecs_div$0$anon3_Then_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> abort_flag@0 (=> (and (=> abort_flag@1 true) (=> true abort_flag@1)) inline$TestSpecs_div$0$Return_correct)))))
(let ((inline$Div$0$anon3_Else_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (and (and (not (= (|i#Integer| inline$Div$0$src2@0) 0)) (= inline$Div$0$dst@1 (Integer (div (|i#Integer| inline$Div$0$src1@0) (|i#Integer| inline$Div$0$src2@0))))) (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0))) (and inline$TestSpecs_div$0$anon3_Then_correct inline$TestSpecs_div$0$anon3_Else_correct)))))
(let ((inline$Div$0$anon3_Then_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= (|i#Integer| inline$Div$0$src2@0) 0) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$TestSpecs_div$0$anon3_Then_correct inline$TestSpecs_div$0$anon3_Else_correct))))))
(let ((inline$Div$0$anon0_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (and (is-Integer inline$Div$0$src1@0) (is-Integer inline$Div$0$src2@0)) (and inline$Div$0$anon3_Then_correct inline$Div$0$anon3_Else_correct)))))
(let ((inline$Div$0$Entry_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (and (= inline$Div$0$src1@0 (GetLocal m@3 (+ local_counter 3))) (= inline$Div$0$src2@0 (GetLocal m@3 (+ local_counter 4)))) inline$Div$0$anon0_correct))))
(let ((inline$TestSpecs_div$0$anon0$2_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (= m@3 (UpdateLocal m@2 (+ local_counter 4) inline$CopyOrMoveValue$1$local@0)) inline$Div$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$1$Entry_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (= inline$CopyOrMoveValue$1$local@0 (GetLocal m@2 (+ local_counter 1))) inline$TestSpecs_div$0$anon0$2_correct))))
(let ((inline$TestSpecs_div$0$anon0$1_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (= m@2 (UpdateLocal m@1 (+ local_counter 3) inline$CopyOrMoveValue$0$local@0)) inline$CopyOrMoveValue$1$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@1 (+ local_counter 0))) inline$TestSpecs_div$0$anon0$1_correct))))
(let ((inline$TestSpecs_div$0$anon0_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (not abort_flag) (=> (and (and (is-Integer x) (>= (|i#Integer| x) 0)) (<= (|i#Integer| x) MAX_U64)) (=> (and (and (and (and (is-Integer y) (>= (|i#Integer| y) 0)) (<= (|i#Integer| y) MAX_U64)) (= local_counter@0 (+ local_counter 7))) (and (= m@0 (UpdateLocal m@@5 (+ local_counter 0) x)) (= m@1 (UpdateLocal m@0 (+ local_counter 1) y)))) inline$CopyOrMoveValue$0$Entry_correct))))))
(let ((inline$TestSpecs_div$0$Entry_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (and (! (or %lbl%@18 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @18) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_div$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_div$0$Entry_correct))))
...
(declare-fun local_counter () Int)
(declare-fun inline$CopyOrMoveValue$3$local@0 () T@Value)
(declare-fun inline$TestSpecs_div_by_zero_detected$0$ret0@1 () T@Value)
(declare-fun abort_flag@0 () Bool)
(declare-fun %lbl%+3 () Bool)
(declare-fun %lbl%+4 () Bool)
(declare-fun m@4 () T@Memory)
...
(declare-fun %lbl%+20 () Bool)
(push 1)
(set-info :boogie-vc-id TestSpecs_div_by_zero_detected_verify)
(assert (not
(let ((inline$TestSpecs_div_by_zero_detected$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1  (=> (|b#Boolean| (Boolean true)) (not abort_flag@1))) :lblneg @1))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon3_Else$2_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (and (= m@6 (UpdateLocal m@5 (+ local_counter 6) inline$CopyOrMoveValue$3$local@0)) (= inline$TestSpecs_div_by_zero_detected$0$ret0@1 (GetLocal m@6 (+ local_counter 6)))) (and (=> abort_flag@1 abort_flag@0) (=> abort_flag@0 abort_flag@1))) inline$TestSpecs_div_by_zero_detected$0$Return_correct))))
(let ((inline$CopyOrMoveValue$3$Entry_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (= inline$CopyOrMoveValue$3$local@0 (GetLocal m@5 (+ local_counter 2))) inline$TestSpecs_div_by_zero_detected$0$anon3_Else$2_correct))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon3_Else$1_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= m@5 (UpdateLocal m@4 (+ local_counter 2) inline$CopyOrMoveValue$2$local@0)) inline$CopyOrMoveValue$3$Entry_correct))))
(let ((inline$CopyOrMoveValue$2$Entry_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (= inline$CopyOrMoveValue$2$local@0 (GetLocal m@4 (+ local_counter 5))) inline$TestSpecs_div_by_zero_detected$0$anon3_Else$1_correct))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon3_Else_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (and (not abort_flag@0) (= m@4 (UpdateLocal m@3 (+ local_counter 5) inline$Div$0$dst))) inline$CopyOrMoveValue$2$Entry_correct))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon3_Then_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> abort_flag@0 (=> (and (=> abort_flag@1 true) (=> true abort_flag@1)) inline$TestSpecs_div_by_zero_detected$0$Return_correct)))))
(let ((inline$Div$0$anon3_Else_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (and (and (not (= (|i#Integer| inline$Div$0$src2@0) 0)) (= inline$Div$0$dst@1 (Integer (div (|i#Integer| inline$Div$0$src1@0) (|i#Integer| inline$Div$0$src2@0))))) (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0))) (and inline$TestSpecs_div_by_zero_detected$0$anon3_Then_correct inline$TestSpecs_div_by_zero_detected$0$anon3_Else_correct)))))
(let ((inline$Div$0$anon3_Then_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= (|i#Integer| inline$Div$0$src2@0) 0) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$TestSpecs_div_by_zero_detected$0$anon3_Then_correct inline$TestSpecs_div_by_zero_detected$0$anon3_Else_correct))))))
(let ((inline$Div$0$anon0_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (and (is-Integer inline$Div$0$src1@0) (is-Integer inline$Div$0$src2@0)) (and inline$Div$0$anon3_Then_correct inline$Div$0$anon3_Else_correct)))))
(let ((inline$Div$0$Entry_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (and (= inline$Div$0$src1@0 (GetLocal m@3 (+ local_counter 3))) (= inline$Div$0$src2@0 (GetLocal m@3 (+ local_counter 4)))) inline$Div$0$anon0_correct))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon0$2_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (= m@3 (UpdateLocal m@2 (+ local_counter 4) inline$CopyOrMoveValue$1$local@0)) inline$Div$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$1$Entry_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (= inline$CopyOrMoveValue$1$local@0 (GetLocal m@2 (+ local_counter 1))) inline$TestSpecs_div_by_zero_detected$0$anon0$2_correct))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon0$1_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (= m@2 (UpdateLocal m@1 (+ local_counter 3) inline$CopyOrMoveValue$0$local@0)) inline$CopyOrMoveValue$1$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@1 (+ local_counter 0))) inline$TestSpecs_div_by_zero_detected$0$anon0$1_correct))))
(let ((inline$TestSpecs_div_by_zero_detected$0$anon0_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (not abort_flag) (=> (and (and (is-Integer x) (>= (|i#Integer| x) 0)) (<= (|i#Integer| x) MAX_U64)) (=> (and (and (and (and (is-Integer y) (>= (|i#Integer| y) 0)) (<= (|i#Integer| y) MAX_U64)) (= local_counter@0 (+ local_counter 7))) (and (= m@0 (UpdateLocal m@@5 (+ local_counter 0) x)) (= m@1 (UpdateLocal m@0 (+ local_counter 1) y)))) inline$CopyOrMoveValue$0$Entry_correct))))))
(let ((inline$TestSpecs_div_by_zero_detected$0$Entry_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (and (! (or %lbl%@18 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @18) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_div_by_zero_detected$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestSpecs_div_by_zero_detected$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+20 true) :lblpos +20) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))))))))
))
(check-sat)
