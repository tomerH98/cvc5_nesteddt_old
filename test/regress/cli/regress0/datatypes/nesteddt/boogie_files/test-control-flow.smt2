; using cav@cav20-artifact:~/artifact/libra/language/move-prover/bytecode-to-boogie$ time cargo run test_mvir/verify-stdlib/test-control-flow.mvir --output test-control-flow.bpl --boogie-exe ~/boogie/Binaries/boogie -B /useArrayTheory --z3-exe /usr/bin/z3 --boogie /proverLog:test-control-flow.smt2
(set-logic ALL)
...
(declare-fun inline$TestControlFlow_branch_once$0$tmp@1 () T@Value)
...
(push 1)
(set-info :boogie-vc-id TestControlFlow_branch_once_verify)
(assert (not
(let ((inline$TestControlFlow_branch_once$0$anon5_Then$1_correct  (=> (! (and %lbl%+0 true) :lblpos +0) true)))
(let ((inline$LdConst$2$anon0_correct  (=> (! (and %lbl%+1 true) :lblpos +1) (=> (= inline$LdConst$2$ret@1 (Integer 0)) inline$TestControlFlow_branch_once$0$anon5_Then$1_correct))))
(let ((inline$TestControlFlow_branch_once$0$anon5_Then_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (not (|b#Boolean| inline$TestControlFlow_branch_once$0$tmp@1)) inline$LdConst$2$anon0_correct))))
(let ((inline$TestControlFlow_branch_once$0$anon6_Else_correct  (=> (! (and %lbl%+3 true) :lblpos +3) true)))
(let ((inline$TestControlFlow_branch_once$0$anon6_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) true)))
(let ((inline$AddU64$0$anon3_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (and (and (>= MAX_U64 (+ (|i#Integer| inline$AddU64$0$src1@0) (|i#Integer| inline$AddU64$0$src2@0))) (= inline$AddU64$0$dst@1 (Integer (+ (|i#Integer| inline$AddU64$0$src1@0) (|i#Integer| inline$AddU64$0$src2@0))))) (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0))) (and inline$TestControlFlow_branch_once$0$anon6_Then_correct inline$TestControlFlow_branch_once$0$anon6_Else_correct)))))
(let ((inline$AddU64$0$anon3_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (> (+ (|i#Integer| inline$AddU64$0$src1@0) (|i#Integer| inline$AddU64$0$src2@0)) MAX_U64) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$TestControlFlow_branch_once$0$anon6_Then_correct inline$TestControlFlow_branch_once$0$anon6_Else_correct))))))
...
(let ((inline$TestControlFlow_branch_once$0$anon5_Else$2_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= m@3 (UpdateLocal m@2 (+ local_counter 3) inline$LdConst$1$ret@1)) inline$AddU64$0$Entry_correct))))
(let ((inline$LdConst$1$anon0_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$LdConst$1$ret@1 (Integer 2)) inline$TestControlFlow_branch_once$0$anon5_Else$2_correct))))
(let ((inline$TestControlFlow_branch_once$0$anon5_Else$1_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (= m@2 (UpdateLocal m@1 (+ local_counter 2) inline$LdConst$0$ret@1)) inline$LdConst$1$anon0_correct))))
(let ((inline$LdConst$0$anon0_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (= inline$LdConst$0$ret@1 (Integer 1)) inline$TestControlFlow_branch_once$0$anon5_Else$1_correct))))
(let ((inline$TestControlFlow_branch_once$0$anon5_Else_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (|b#Boolean| inline$TestControlFlow_branch_once$0$tmp@1) inline$LdConst$0$anon0_correct))))
(let ((inline$TestControlFlow_branch_once$0$anon0$1_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (and (= m@1 (UpdateLocal m@0 (+ local_counter 1) inline$CopyOrMoveValue$0$local@0)) (= inline$TestControlFlow_branch_once$0$tmp@1 (GetLocal m@1 (+ local_counter 1)))) (and inline$TestControlFlow_branch_once$0$anon5_Then_correct inline$TestControlFlow_branch_once$0$anon5_Else_correct)))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 0))) inline$TestControlFlow_branch_once$0$anon0$1_correct))))
(let ((inline$TestControlFlow_branch_once$0$anon0_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (and (and (not abort_flag) (is-Boolean cond)) (and (= local_counter@0 (+ local_counter 6)) (= m@0 (UpdateLocal m@@5 (+ local_counter 0) cond)))) inline$CopyOrMoveValue$0$Entry_correct))))
(let ((inline$TestControlFlow_branch_once$0$Entry_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (and (! (or %lbl%@18 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @18) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestControlFlow_branch_once$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$TestControlFlow_branch_once$0$Entry_correct))))
