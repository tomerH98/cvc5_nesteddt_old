; using cav@cav20-artifact:~/artifact/libra/language/move-prover/bytecode-to-boogie$ time cargo run test_mvir/verify-stdlib/verify-cast.mvir --output verify-cast.bpl --boogie-exe ~/boogie/Binaries/boogie -B /useArrayTheory --z3-exe /usr/bin/z3 --boogie /proverLog:verify-cast.smt2
(set-logic ALL)
...
(declare-fun inline$CastU8$0$dst () T@Value)
(declare-fun inline$CastBad_aborting_u8_cast_bad$0$ret0@1 () T@Value)
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%+5 () Bool)
(declare-fun inline$CastU8$0$src@0 () T@Value)
...
(push 1)
(set-info :boogie-vc-id CastBad_aborting_u8_cast_bad_verify)
(assert (not
(let ((inline$CastBad_aborting_u8_cast_bad$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1  (=> (not (|b#Boolean| (Boolean false))) (not abort_flag@1))) :lblneg @1) (=> (=> (not (|b#Boolean| (Boolean false))) (not abort_flag@1)) (! (or %lbl%@2  (=> (|b#Boolean| (Boolean false)) abort_flag@1)) :lblneg @2))))))
(let ((inline$CastBad_aborting_u8_cast_bad$0$anon3_Else_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (not abort_flag@0) (=> (and (and (= m@2 (UpdateLocal m@1 (+ local_counter 2) inline$CastU8$0$dst)) (= inline$CastBad_aborting_u8_cast_bad$0$ret0@1 (GetLocal m@2 (+ local_counter 2)))) (and (=> abort_flag@1 abort_flag@0) (=> abort_flag@0 abort_flag@1))) inline$CastBad_aborting_u8_cast_bad$0$Return_correct)))))
(let ((inline$CastBad_aborting_u8_cast_bad$0$anon3_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> abort_flag@0 (=> (and (=> abort_flag@1 true) (=> true abort_flag@1)) inline$CastBad_aborting_u8_cast_bad$0$Return_correct)))))
(let ((inline$CastU8$0$anon3_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (>= MAX_U8 (|i#Integer| inline$CastU8$0$src@0)) (=> (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0)) (and inline$CastBad_aborting_u8_cast_bad$0$anon3_Then_correct inline$CastBad_aborting_u8_cast_bad$0$anon3_Else_correct))))))
(let ((inline$CastU8$0$anon3_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (> (|i#Integer| inline$CastU8$0$src@0) MAX_U8) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$CastBad_aborting_u8_cast_bad$0$anon3_Then_correct inline$CastBad_aborting_u8_cast_bad$0$anon3_Else_correct))))))
(let ((inline$CastU8$0$anon0_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (is-Integer inline$CastU8$0$src@0) (and inline$CastU8$0$anon3_Then_correct inline$CastU8$0$anon3_Else_correct)))))
(let ((inline$CastU8$0$Entry_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (= inline$CastU8$0$src@0 (GetLocal m@1 (+ local_counter 1))) inline$CastU8$0$anon0_correct))))
(let ((inline$CastBad_aborting_u8_cast_bad$0$anon0$1_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= m@1 (UpdateLocal m@0 (+ local_counter 1) inline$CopyOrMoveValue$0$local@0)) inline$CastU8$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 0))) inline$CastBad_aborting_u8_cast_bad$0$anon0$1_correct))))
(let ((inline$CastBad_aborting_u8_cast_bad$0$anon0_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (not abort_flag) (=> (and (and (and (is-Integer x) (>= (|i#Integer| x) 0)) (<= (|i#Integer| x) MAX_U64)) (and (= local_counter@0 (+ local_counter 3)) (= m@0 (UpdateLocal m@@5 (+ local_counter 0) x)))) inline$CopyOrMoveValue$0$Entry_correct)))))
(let ((inline$CastBad_aborting_u8_cast_bad$0$Entry_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (and (! (or %lbl%@13 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @13) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u8_cast_bad$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u8_cast_bad$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) anon0_correct)))
...
(declare-fun local_counter () Int)
(declare-fun inline$CastU8$0$dst () T@Value)
(declare-fun inline$CastBad_aborting_u8_cast_ok$0$ret0@1 () T@Value)
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%+5 () Bool)
(declare-fun inline$CastU8$0$src@0 () T@Value)
(declare-fun abort_flag () Bool)
...
(declare-fun %lbl%+15 () Bool)
(push 1)
(set-info :boogie-vc-id CastBad_aborting_u8_cast_ok_verify)
(assert (not
(let ((inline$CastBad_aborting_u8_cast_ok$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1  (=> (not (|b#Boolean| (Boolean (> (|i#Integer| x) (|i#Integer| (Integer 255)))))) (not abort_flag@1))) :lblneg @1) (=> (=> (not (|b#Boolean| (Boolean (> (|i#Integer| x) (|i#Integer| (Integer 255)))))) (not abort_flag@1)) (! (or %lbl%@2  (=> (|b#Boolean| (Boolean (> (|i#Integer| x) (|i#Integer| (Integer 255))))) abort_flag@1)) :lblneg @2))))))
(let ((inline$CastBad_aborting_u8_cast_ok$0$anon3_Else_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (not abort_flag@0) (=> (and (and (= m@2 (UpdateLocal m@1 (+ local_counter 2) inline$CastU8$0$dst)) (= inline$CastBad_aborting_u8_cast_ok$0$ret0@1 (GetLocal m@2 (+ local_counter 2)))) (and (=> abort_flag@1 abort_flag@0) (=> abort_flag@0 abort_flag@1))) inline$CastBad_aborting_u8_cast_ok$0$Return_correct)))))
(let ((inline$CastBad_aborting_u8_cast_ok$0$anon3_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> abort_flag@0 (=> (and (=> abort_flag@1 true) (=> true abort_flag@1)) inline$CastBad_aborting_u8_cast_ok$0$Return_correct)))))
(let ((inline$CastU8$0$anon3_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (>= MAX_U8 (|i#Integer| inline$CastU8$0$src@0)) (=> (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0)) (and inline$CastBad_aborting_u8_cast_ok$0$anon3_Then_correct inline$CastBad_aborting_u8_cast_ok$0$anon3_Else_correct))))))
(let ((inline$CastU8$0$anon3_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (> (|i#Integer| inline$CastU8$0$src@0) MAX_U8) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$CastBad_aborting_u8_cast_ok$0$anon3_Then_correct inline$CastBad_aborting_u8_cast_ok$0$anon3_Else_correct))))))
(let ((inline$CastU8$0$anon0_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (is-Integer inline$CastU8$0$src@0) (and inline$CastU8$0$anon3_Then_correct inline$CastU8$0$anon3_Else_correct)))))
(let ((inline$CastU8$0$Entry_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (= inline$CastU8$0$src@0 (GetLocal m@1 (+ local_counter 1))) inline$CastU8$0$anon0_correct))))
(let ((inline$CastBad_aborting_u8_cast_ok$0$anon0$1_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= m@1 (UpdateLocal m@0 (+ local_counter 1) inline$CopyOrMoveValue$0$local@0)) inline$CastU8$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 0))) inline$CastBad_aborting_u8_cast_ok$0$anon0$1_correct))))
(let ((inline$CastBad_aborting_u8_cast_ok$0$anon0_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (not abort_flag) (=> (and (and (and (is-Integer x) (>= (|i#Integer| x) 0)) (<= (|i#Integer| x) MAX_U64)) (and (= local_counter@0 (+ local_counter 3)) (= m@0 (UpdateLocal m@@5 (+ local_counter 0) x)))) inline$CopyOrMoveValue$0$Entry_correct)))))
(let ((inline$CastBad_aborting_u8_cast_ok$0$Entry_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (and (! (or %lbl%@13 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @13) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u8_cast_ok$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u8_cast_ok$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))
))
(check-sat)
...
(declare-fun m@1 () T@Memory)
(declare-fun local_counter () Int)
(declare-fun inline$CastU64$0$dst () T@Value)
(declare-fun inline$CastBad_aborting_u64_cast_bad$0$ret0@1 () T@Value)
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%+5 () Bool)
(declare-fun inline$CastU64$0$src@0 () T@Value)
(declare-fun abort_flag () Bool)
(declare-fun %lbl%+6 () Bool)
(declare-fun %lbl%+7 () Bool)
(declare-fun %lbl%+8 () Bool)
...
(declare-fun %lbl%+15 () Bool)
(push 1)
(set-info :boogie-vc-id CastBad_aborting_u64_cast_bad_verify)
(assert (not
(let ((inline$CastBad_aborting_u64_cast_bad$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1  (=> (not (|b#Boolean| (Boolean false))) (not abort_flag@1))) :lblneg @1) (=> (=> (not (|b#Boolean| (Boolean false))) (not abort_flag@1)) (! (or %lbl%@2  (=> (|b#Boolean| (Boolean false)) abort_flag@1)) :lblneg @2))))))
(let ((inline$CastBad_aborting_u64_cast_bad$0$anon3_Else_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (not abort_flag@0) (=> (and (and (= m@2 (UpdateLocal m@1 (+ local_counter 2) inline$CastU64$0$dst)) (= inline$CastBad_aborting_u64_cast_bad$0$ret0@1 (GetLocal m@2 (+ local_counter 2)))) (and (=> abort_flag@1 abort_flag@0) (=> abort_flag@0 abort_flag@1))) inline$CastBad_aborting_u64_cast_bad$0$Return_correct)))))
(let ((inline$CastBad_aborting_u64_cast_bad$0$anon3_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> abort_flag@0 (=> (and (=> abort_flag@1 true) (=> true abort_flag@1)) inline$CastBad_aborting_u64_cast_bad$0$Return_correct)))))
(let ((inline$CastU64$0$anon3_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (>= MAX_U64 (|i#Integer| inline$CastU64$0$src@0)) (=> (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0)) (and inline$CastBad_aborting_u64_cast_bad$0$anon3_Then_correct inline$CastBad_aborting_u64_cast_bad$0$anon3_Else_correct))))))
(let ((inline$CastU64$0$anon3_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (> (|i#Integer| inline$CastU64$0$src@0) MAX_U64) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$CastBad_aborting_u64_cast_bad$0$anon3_Then_correct inline$CastBad_aborting_u64_cast_bad$0$anon3_Else_correct))))))
(let ((inline$CastU64$0$anon0_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (is-Integer inline$CastU64$0$src@0) (and inline$CastU64$0$anon3_Then_correct inline$CastU64$0$anon3_Else_correct)))))
(let ((inline$CastU64$0$Entry_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (= inline$CastU64$0$src@0 (GetLocal m@1 (+ local_counter 1))) inline$CastU64$0$anon0_correct))))
(let ((inline$CastBad_aborting_u64_cast_bad$0$anon0$1_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= m@1 (UpdateLocal m@0 (+ local_counter 1) inline$CopyOrMoveValue$0$local@0)) inline$CastU64$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 0))) inline$CastBad_aborting_u64_cast_bad$0$anon0$1_correct))))
(let ((inline$CastBad_aborting_u64_cast_bad$0$anon0_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (not abort_flag) (=> (and (and (and (is-Integer x) (>= (|i#Integer| x) 0)) (<= (|i#Integer| x) MAX_U128)) (and (= local_counter@0 (+ local_counter 3)) (= m@0 (UpdateLocal m@@5 (+ local_counter 0) x)))) inline$CopyOrMoveValue$0$Entry_correct)))))
(let ((inline$CastBad_aborting_u64_cast_bad$0$Entry_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (and (! (or %lbl%@13 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @13) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u64_cast_bad$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u64_cast_bad$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))
))
(check-sat)
...
(declare-fun local_counter () Int)
(declare-fun inline$CastU64$0$dst () T@Value)
(declare-fun inline$CastBad_aborting_u64_cast_ok$0$ret0@1 () T@Value)
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%+5 () Bool)
(declare-fun inline$CastU64$0$src@0 () T@Value)
(declare-fun abort_flag () Bool)
...
(declare-fun %lbl%+15 () Bool)
(push 1)
(set-info :boogie-vc-id CastBad_aborting_u64_cast_ok_verify)
(assert (not
(let ((inline$CastBad_aborting_u64_cast_ok$0$Return_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1  (=> (not (|b#Boolean| (Boolean (> (|i#Integer| x) (|i#Integer| (Integer 9223372036854775807)))))) (not abort_flag@1))) :lblneg @1) (=> (=> (not (|b#Boolean| (Boolean (> (|i#Integer| x) (|i#Integer| (Integer 9223372036854775807)))))) (not abort_flag@1)) (! (or %lbl%@2  (=> (|b#Boolean| (Boolean (> (|i#Integer| x) (|i#Integer| (Integer 9223372036854775807))))) abort_flag@1)) :lblneg @2))))))
(let ((inline$CastBad_aborting_u64_cast_ok$0$anon3_Else_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (not abort_flag@0) (=> (and (and (= m@2 (UpdateLocal m@1 (+ local_counter 2) inline$CastU64$0$dst)) (= inline$CastBad_aborting_u64_cast_ok$0$ret0@1 (GetLocal m@2 (+ local_counter 2)))) (and (=> abort_flag@1 abort_flag@0) (=> abort_flag@0 abort_flag@1))) inline$CastBad_aborting_u64_cast_ok$0$Return_correct)))))
(let ((inline$CastBad_aborting_u64_cast_ok$0$anon3_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> abort_flag@0 (=> (and (=> abort_flag@1 true) (=> true abort_flag@1)) inline$CastBad_aborting_u64_cast_ok$0$Return_correct)))))
(let ((inline$CastU64$0$anon3_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (>= MAX_U64 (|i#Integer| inline$CastU64$0$src@0)) (=> (and (=> abort_flag@0 abort_flag) (=> abort_flag abort_flag@0)) (and inline$CastBad_aborting_u64_cast_ok$0$anon3_Then_correct inline$CastBad_aborting_u64_cast_ok$0$anon3_Else_correct))))))
(let ((inline$CastU64$0$anon3_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (> (|i#Integer| inline$CastU64$0$src@0) MAX_U64) (=> (and (=> abort_flag@0 true) (=> true abort_flag@0)) (and inline$CastBad_aborting_u64_cast_ok$0$anon3_Then_correct inline$CastBad_aborting_u64_cast_ok$0$anon3_Else_correct))))))
(let ((inline$CastU64$0$anon0_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (is-Integer inline$CastU64$0$src@0) (and inline$CastU64$0$anon3_Then_correct inline$CastU64$0$anon3_Else_correct)))))
(let ((inline$CastU64$0$Entry_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (= inline$CastU64$0$src@0 (GetLocal m@1 (+ local_counter 1))) inline$CastU64$0$anon0_correct))))
(let ((inline$CastBad_aborting_u64_cast_ok$0$anon0$1_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= m@1 (UpdateLocal m@0 (+ local_counter 1) inline$CopyOrMoveValue$0$local@0)) inline$CastU64$0$Entry_correct))))
(let ((inline$CopyOrMoveValue$0$Entry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (= inline$CopyOrMoveValue$0$local@0 (GetLocal m@0 (+ local_counter 0))) inline$CastBad_aborting_u64_cast_ok$0$anon0$1_correct))))
(let ((inline$CastBad_aborting_u64_cast_ok$0$anon0_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (not abort_flag) (=> (and (and (and (is-Integer x) (>= (|i#Integer| x) 0)) (<= (|i#Integer| x) MAX_U128)) (and (= local_counter@0 (+ local_counter 3)) (= m@0 (UpdateLocal m@@5 (+ local_counter 0) x)))) inline$CopyOrMoveValue$0$Entry_correct)))))
(let ((inline$CastBad_aborting_u64_cast_ok$0$Entry_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (and (! (or %lbl%@13 (ExistsTxnSenderAccount m@@5 txn@@1)) :lblneg @13) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u64_cast_ok$0$anon0_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (ExistsTxnSenderAccount m@@5 txn@@1) inline$CastBad_aborting_u64_cast_ok$0$Entry_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+15 true) :lblpos +15) anon0_correct)))
PreconditionGeneratedEntry_correct)))))))))))))
))
(check-sat)
